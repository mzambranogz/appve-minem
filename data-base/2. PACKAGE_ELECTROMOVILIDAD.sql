...
--------------------------------------------------------
  ...
  PROCEDURE USP_UPD_ACTUALIZAR_RECUPERAR(
    PI_ID_USUARIO NUMBER,
    PI_FLAG_RECUPERAR NUMBER,
...
--------------------------------------------------------
  ...
  PROCEDURE USP_PRC_GUARDAR_ESTACION(
    ...
    PI_ID_POTENCIA NUMBER,
    PI_ID_MODO_CARGA NUMBER,
    PI_TIPO_CARGADOR VARCHAR2,
    --PI_TIPO_CONECTOR VARCHAR2,
    PI_ID_TIPO_CONECTOR NUMBER,
    PI_CABLE NUMBER,
  ...
  PROCEDURE USP_PRC_GUARDAR_VEH_RUTA(
    PI_ID_RESULTADO NUMBER,
    PI_ID_USUARIO NUMBER,
    PI_ID_RUTA NUMBER,
    PI_NOMBRE_RUTA VARCHAR2,
    PI_NOMBRE_ORIGEN VARCHAR2,
    PI_NOMBRE_DESTINO VARCHAR2,
    PI_VECES_SEMANAL NUMBER,
    PI_KM_DIARIO NUMBER,
    PI_KM_SEMANAL NUMBER,
    PI_ORIGEN VARCHAR2,
    PI_DESTINO VARCHAR2,
    PI_FLAG_ESTADO VARCHAR2,
    PI_UPD_USUARIO NUMBER,
  ...
  PROCEDURE USP_SEL_LISTA_VEH_RUTA(
    PI_ID_USUARIO NUMBER,
    PO_REF OUT SYS_REFCURSOR
  );
...
--------------------------------------------------------
  ...
  PROCEDURE USP_SEL_LIST_POTENCIA(
    PO_REF OUT SYS_REFCURSOR
  );
  
  PROCEDURE USP_SEL_LIST_TIPO_CONECTOR(
    PO_REF OUT SYS_REFCURSOR
  );
  
  PROCEDURE USP_SEL_LIST_MODO_CARGA(
    PO_REF OUT SYS_REFCURSOR
  );
...
--------------------------------------------------------
  ...
  BEGIN
        ...
        FROM T_GENM_USUARIO
        WHERE LOWER(TRANSLATE(CORREO,'¡…Õ”⁄·ÈÌÛ˙','AEIOUaeiou')) = LOWER(TRANSLATE(PI_EMAIL_USUARIO,'¡…Õ”⁄·ÈÌÛ˙','AEIOUaeiou')) AND FLAG_ESTADO = '1';
  ...
  BEGIN
      ...
      WHERE LOWER(TRANSLATE(U.CORREO,'¡…Õ”⁄·ÈÌÛ˙','AEIOUaeiou')) = LOWER(TRANSLATE(PI_CORREO,'¡…Õ”⁄·ÈÌÛ˙','AEIOUaeiou'));
  ...
  BEGIN
    ...
    FLAG_RECUPERAR = PI_FLAG_RECUPERAR
    WHERE ID_USUARIO = PI_ID_USUARIO;
    PO_ROWAFFECTED := SQL%ROWCOUNT;
  END USP_UPD_ACTUALIZAR_RECUPERAR;
...
--------------------------------------------------------
  ...
  BEGIN    
    IF PI_ID_ESTACION = -1 THEN
      ...
      (ID_ESTACION, LONGITUD, LATITUD, DIRECCION, DESCRIPCION, MODELO, MARCA, ID_POTENCIA, ID_MODO_CARGA, TIPO_CARGADOR, ID_TIPO_CONECTOR, CABLE, CANTIDAD_CONECTOR, HORA_DESDE, HORA_HASTA, TARIFA_SERVICIO, ID_USUARIO, ID_ESTADO, REG_USUARIO, REG_FECHA)
      VALUES
      (PI_ID_GET, PI_LONGITUD, PI_LATITUD, PI_DIRECCION, PI_DESCRIPCION, PI_MODELO, PI_MARCA, PI_ID_POTENCIA, PI_ID_MODO_CARGA, PI_TIPO_CARGADOR, PI_ID_TIPO_CONECTOR, PI_CABLE, PI_CANTIDAD_CONECTOR, PI_HORA_DESDE, PI_HORA_HASTA, PI_TARIFA_SERVICIO, PI_ID_USUARIO, PI_ID_ESTADO, PI_UPD_USUARIO, SYSDATE);
      
      UPDATE T_GENM_USUARIO SET PROPIETARIO = '1' WHERE ID_USUARIO = PI_ID_USUARIO;
    ELSE
      UPDATE T_GENM_ESTACION C SET
      C.LONGITUD = PI_LONGITUD,
      C.LATITUD = PI_LATITUD,
      C.DIRECCION = PI_DIRECCION,
      C.DESCRIPCION = PI_DESCRIPCION,
      C.MODELO = PI_MODELO,
      C.MARCA = PI_MARCA,
      C.ID_POTENCIA = PI_ID_POTENCIA,
      C.ID_MODO_CARGA = PI_ID_MODO_CARGA,
      C.TIPO_CARGADOR = PI_TIPO_CARGADOR,
      C.ID_TIPO_CONECTOR = PI_ID_TIPO_CONECTOR,
      C.CABLE = PI_CABLE,
  ...
  BEGIN
    OPEN PO_REF FOR
    SELECT  
    E.*, P.NOMBRE POTENCIA, TC.NOMBRE TIPO_CONECTOR, MC.NOMBRE MODO_CARGA
    FROM  T_GENM_ESTACION E
    LEFT JOIN T_GENM_POTENCIA P ON E.ID_POTENCIA = P.ID_POTENCIA
    LEFT JOIN T_GENM_TIPO_CONECTOR TC ON E.ID_TIPO_CONECTOR = TC.ID_TIPO_CONECTOR
    LEFT JOIN T_GENM_MODO_CARGA MC ON E.ID_MODO_CARGA = MC.ID_MODO_CARGA
    WHERE E.FLAG_ESTADO = '1' AND E.ID_USUARIO = PI_ID_USUARIO
  ...
  BEGIN
    OPEN PO_REF FOR
    SELECT
    E.*, I.RAZON_SOCIAL NOMBRE_INSTITUCION, P.NOMBRE POTENCIA, TC.NOMBRE TIPO_CONECTOR, MC.NOMBRE MODO_CARGA
    FROM  T_GENM_ESTACION E
    INNER JOIN T_GENM_USUARIO U ON E.ID_USUARIO = U.ID_USUARIO
    LEFT JOIN T_GENM_INSTITUCION I ON U.ID_INSTITUCION = I.ID_INSTITUCION
    LEFT JOIN T_GENM_POTENCIA P ON E.ID_POTENCIA = P.ID_POTENCIA
    LEFT JOIN T_GENM_TIPO_CONECTOR TC ON E.ID_TIPO_CONECTOR = TC.ID_TIPO_CONECTOR
    LEFT JOIN T_GENM_MODO_CARGA MC ON E.ID_MODO_CARGA = MC.ID_MODO_CARGA
    WHERE  E.ID_ESTACION = PI_ID_ESTACION;
  ...
  BEGIN
    ...
    *
    ...
    WHERE FLAG_ESTADO = '1' AND ID_ESTADO IN (1,2)
          AND TO_NUMBER(LONGITUD,'9999999999990.0000000000000000') >= PI_MIN_LNG AND TO_NUMBER(LONGITUD,'9999999999990.0000000000000000') <= PI_MAX_LNG
          AND TO_NUMBER(LATITUD,'9999999999990.0000000000000000') >= PI_MIN_LAT AND TO_NUMBER(LATITUD,'9999999999990.0000000000000000') <= PI_MAX_LAT
  ...
  PROCEDURE USP_PRC_GUARDAR_VEH_RUTA(
    ...
    vID NUMBER;
  BEGIN
    IF PI_ID_RUTA = 0 THEN
      SELECT NVL(MAX(ID_RUTA),0) + 1 INTO vID FROM T_GEND_VEHICULO_RUTA WHERE ID_USUARIO = PI_ID_USUARIO;
      INSERT INTO T_GEND_VEHICULO_RUTA (ID_RESULTADO, ID_USUARIO, ID_RUTA, NOMBRE_RUTA, NOMBRE_ORIGEN, NOMBRE_DESTINO, VECES_SEMANA, KM_DIARIO, KM_SEMANAL, ORIGEN, DESTINO, REG_USUARIO, REG_FECHA)
      VALUES (PI_ID_RESULTADO, PI_ID_USUARIO, vID, PI_NOMBRE_RUTA, PI_NOMBRE_ORIGEN, PI_NOMBRE_DESTINO, PI_VECES_SEMANAL, PI_KM_DIARIO, PI_KM_SEMANAL, PI_ORIGEN, PI_DESTINO, PI_UPD_USUARIO, SYSDATE);
    ELSE
      UPDATE T_GEND_VEHICULO_RUTA SET
      NOMBRE_RUTA = PI_NOMBRE_RUTA,
      NOMBRE_ORIGEN = PI_NOMBRE_ORIGEN,
      NOMBRE_DESTINO = PI_NOMBRE_DESTINO,
      VECES_SEMANA = PI_VECES_SEMANAL, 
      KM_DIARIO = PI_KM_DIARIO,
      KM_SEMANAL = PI_KM_SEMANAL,
      ORIGEN = PI_ORIGEN,
      DESTINO = PI_DESTINO,
      FLAG_ESTADO = PI_FLAG_ESTADO,
      UPD_USUARIO = PI_ID_USUARIO,
      UPD_FECHA = SYSDATE
      WHERE ID_USUARIO = PI_ID_USUARIO AND ID_RUTA = PI_ID_RUTA;
    END IF;
    
    PO_ROWAFFECTED := SQL%ROWCOUNT;
  END USP_PRC_GUARDAR_VEH_RUTA;
...
--------------------------------------------------------
  ...
  BEGIN
    ...
    IF vID IS NULL THEN
      ...
      (ID_USUARIO, NOMBRES, ID_GENERO, CORREO, CONTRASENA, ID_ROL, TIPO_REGISTRO, FLAG_ESTADO, REG_USUARIO, REG_FECHA)
      VALUES
      (PI_ID_USUARIO, PI_NOMBRES, PI_ID_GENERO, PI_CORREO, PI_CONTRASENA, PI_ID_ROL, PI_TIPO_REGISTRO, PI_FLAG_ESTADO, PI_ID_USUARIO, SYSDATE);
  ...
  BEGIN
    OPEN PO_REF FOR
    SELECT * FROM T_GENM_POTENCIA
    WHERE FLAG_ESTADO = '1'
    ORDER BY ID_POTENCIA ASC;
  END USP_SEL_LIST_POTENCIA;
  ...
  BEGIN
    OPEN PO_REF FOR
    SELECT * FROM T_GENM_TIPO_CONECTOR
    WHERE FLAG_ESTADO = '1'
    ORDER BY ID_TIPO_CONECTOR ASC;
  END USP_SEL_LIST_TIPO_CONECTOR;
  ...
  BEGIN
    OPEN PO_REF FOR
    SELECT * FROM T_GENM_MODO_CARGA
    WHERE FLAG_ESTADO = '1'
    ORDER BY ID_MODO_CARGA ASC;
  END USP_SEL_LIST_MODO_CARGA;
