...
{
    public partial class ReporteReconocimientoXConvocatoriaEmpresa : System.Web.UI.Page
    {
        ...
        protected void btnConsultar_Click(object sender, EventArgs e)
        {
            ...
            List<ReporteBE.ReporteReconocimientoEmpresa> dataReporte = new ReporteLN().ListaReporteReconocimientoEmpresa(idConvocatoria, idEmpresa);
            ReportDataSource dsReporte = new ReportDataSource("dsReconocimientoEmpresa", dataReporte);
            ...
            rpwReporte.LocalReport.EnableExternalImages = true;
